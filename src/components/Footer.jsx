...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#7C4A21] text-white border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-white">
              <li className="flex items-center space-x-2">
                <span className="text-[#fffdd0] font-medium">Email:</span>
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=hello@sweetcrumbsbakery.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-[#c97a28] transition-colors"
                >
                  hello@sweetcrumbsbakery.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <span className="text-[#fffdd0] font-medium">Phone:</span>
                <a
              ...
              <li className="flex items-center space-x-2">
                <span className="text-[#fffdd0] font-medium">Whatsapp:</span>
                <a
              ...
              <li className="flex items-start space-x-2">
                <span className="text-[#fffdd0] font-medium whitespace-nowrap">
                  HQ:
                </span>
                <span>
                  123 Maple Street
                  <br /> Springfield,IL 62701 <br />
                  USA
                </span>
              </li>
            </ul>
            ...
            <div className="flex space-x-4 pt-1">
              {socialLinks.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="p-2 bg-[#f59e0b] rounded-md text-white hover:text-white hover:bg-[#c97a28] transition-all duration-200"
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-xs text-white">
          <p>
            &copy; {currentYear} Sweet Crumbs Bakery Inc. All rights reserved.
          </p>
